...
topic: "ci-fixes"
language: "zh-CN"
source_path: "tasks/fix-ci/moca-juno-fix-CI.md"
---
...
- **PR 链接**: https://github.com/mocachain/moca-juno/pull/7
...
moca-juno 与 moca-callisto-juno 的配置几乎相同,使用了相同的修复方案:

### 相同点

1. 都使用 `make lint` 运行 golangci-lint
2. 都需要在 go.mod 中升级 golangci-lint 版本
3. 都使用相同的废弃 linters
4. 都需要相同的替代 linters
5. 都使用 Go 1.23.6
